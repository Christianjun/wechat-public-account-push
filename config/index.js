export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx6cb7caa712f6dbca",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "d15187f3b70d3137dc277b345a755d56",
  ...
  USERS: [
    {
      ...
      id: "oiRqa5jCEb8G_nyiCryNfcfvRgVI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "eW-eNIIumkXPFUyixfqITObvBzWs4_6etizU5ug5ULY",
      // 所在省份
      province: "北京",
      // 所在城市
      city: "朝阳",
